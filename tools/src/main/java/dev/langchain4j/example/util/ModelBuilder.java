...
public class ModelBuilder {
    ...
    private StreamingChatModel streamingChatModelForWeb = null;
    ...
    public StreamingChatModel getStreamingChatModelForWeb() throws Exception {
        if (streamingChatModelForWeb == null) {
            if (usingGithub()) {
                streamingChatModelForWeb = GitHubModelsStreamingChatModel.builder()
                    .gitHubToken(GITHUB_API_KEY)
                    .modelName(GITHUB_CHAT_MODEL_ID)
                    .timeout(ofSeconds(TIMEOUT))
                    .temperature(TEMPERATURE)
                ...
                streamingChatModelForWeb = OllamaStreamingChatModel.builder()
                    .baseUrl(OLLAMA_BASE_URL)
                    .modelName(OLLAMA_CHAT_MODEL_ID)
                    .timeout(ofSeconds(TIMEOUT))
                    .temperature(TEMPERATURE)
                ...
                streamingChatModelForWeb = MistralAiStreamingChatModel.builder()
                    .apiKey(MISTRAL_AI_API_KEY)
                    .modelName(MISTRAL_AI_MISTRAL_CHAT_MODEL_ID)
                    .timeout(ofSeconds(TIMEOUT))
                    .temperature(TEMPERATURE)
        ...
        return streamingChatModelForWeb;
    }
