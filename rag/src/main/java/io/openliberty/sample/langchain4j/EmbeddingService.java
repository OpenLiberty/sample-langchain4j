...
public class EmbeddingService {
    ...
    @Parameters(value = {
            @Parameter(name = "embeddingID", in = ParameterIn.QUERY, description = "The id of the embedding", required = true, example = "12345", schema = @Schema(type = SchemaType.STRING)),
            @Parameter(name = "tags", in = ParameterIn.QUERY, description = "The tags of the embedding", required = true, example = "jakartaee,liberty,maven,microprofile", schema = @Schema(type = SchemaType.STRING)),
    ...
    @Parameters(value = {
            ...
            @Parameter(name = "embeddingID", in = ParameterIn.QUERY, description = "The id of the embedding", required = true, example = "12345", schema = @Schema(type = SchemaType.STRING)),
            @Parameter(name = "tags", in = ParameterIn.QUERY, description = "The tags of the embedding", required = true, example = "health,jakartaee,maven,microprofile", schema = @Schema(type = SchemaType.STRING)),
            @Parameter(name = "summary", in = ParameterIn.QUERY, description = "The summary of the embedding", required = true, schema = @Schema(type = SchemaType.STRING)),
            @Parameter(name = "content", in = ParameterIn.QUERY, description = "The content of the embedding", required = true, schema = @Schema(type = SchemaType.STRING)) })
